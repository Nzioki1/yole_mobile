      ...
      builder: (context, constraints) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              l10n.logIn,
              style: TextStyle(color: theme.appBarTheme.titleTextStyle?.color, fontSize: 18, fontWeight: FontWeight.w600),
            ),
            actions: [
              IconButton(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        YoleLogo(
                          isDarkTheme: isDark,
                          height: 80.0, // Increased from 48 to 80 for prominence
                        ),
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                filled: true,
                                fillColor: isDark ? theme.cardColor.withValues(alpha: 0.3) : Colors.grey.shade100,
                        ...
                        Align(
                          ...
                          child: TextButton(
                            onPressed: () => Navigator.of(context).pushNamed(widget.forgotPasswordRoute),
                            child: Text(
                              l10n.forgotPassword,
                              style: TextStyle(
                                fontSize: 16,
